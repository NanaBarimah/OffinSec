                    ...
                    <table width="100%" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td style="text-align: center">
                                <a href="#" style="display: block;margin-bottom: 10px;"> <img src="{{asset('assets/images/offin-logo.png')}}" height="28" alt="logo"/></a> <br/>
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                ...
                                valign="top">
                                Hello, your scheduled report is ready.
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                valign="top">
                                Per agreement, find attached to this email your report for the period <b>{{Carbon\Carbon::parse($start_date)->format('jS F Y')}}</b> to <b>{{Carbon\Carbon::parse($end_date)->format('jS F Y')}}</b>. Download the report by clicking on the button below.
                            </td>
                        </tr>
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                        ...
                        <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                            <td class="content-block"
                                style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;"
                                valign="top">
                                &mdash; <b>Offin Security</b> - Guard Attendance Management System.
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <table width="100%"
                ...
                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
                    <td class="aligncenter content-block"
                        ...
                        align="center" valign="top"><a href="http://codbitgh.com"
                                                       style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 12px; color: #999; text-decoration: underline; margin: 0;">&copy; Offin Security Guard Attendance Management System - By Codbit Ghana Limited</a>
                    </td>
                </tr>
            </table>
        </div>
